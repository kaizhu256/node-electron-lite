...
shNpmPostinstall() {
    ...
    Darwin)
        ...
        FILE_TMP=$DIR_TMP/electron-v0.35.2-darwin-x64.zip || return $?
        FILE_URL=https://github.com/atom/electron/releases/download\
/v0.35.2/electron-v0.35.2-darwin-x64.zip || return $?
        shDownload || return $?
        # link electron
    ...
    Linux)
        ...
        FILE_TMP=$DIR_TMP/electron-v0.35.2-linux-x64.zip || return $?
        FILE_URL=https://github.com/atom/electron/releases/download\
/v0.35.2/electron-v0.35.2-linux-x64.zip || return $?
        shDownload || return $?
        ;;
    esac
}
